  ...
  <div class="xtx-pay-page">
    <div class="container">
      ...
      <div class="pay-result">
        ...
        <template v-if="$route.query.payResult">
          <p class="tip">我们将尽快为您发货，收货期间请保持手机畅通</p>
          <p>支付方式：<span>支付宝支付</span></p>
          <p>支付金额：<span>¥{{oreder?.payMoney}}</span></p>
        </template>
        <div class="btn">
...
export default {
  ...
  setup () {
    ...
    const oreder = ref(null)
    findOrderDetail(route.query.oreder).then((data) => {
      oreder.value = data.result
    })
    return {
      oreder
    }
